...
/*********************************{
@cl: TestObject
@d: NOTE: NOT A PART OF THE ACTUAL PHYSICS ENGINE. This is an example class that demonstrates how to integrate the physics engine with a 'game object'. This class should NOT be included in a final product involving the physics engine! It serves as an example only!
}*********************************/
...
function TestObject(name, x, y, width, height, color)
{
	...
	this.physics = new Physics(); //{@p:physics @d: @l:Physics object that contains all of the physical properties of this object}
	...
	this.clickable = false; //{@p:clickable @d: Boolean value representing whether the object will respond to a mouse click or not.}
	this.damagable = true; //{@p:damagable @d: Boolean value representing whether the object can be damaged or not.}

	this.health = 1000; //{@p:health @d: Remaining health, if damage is enabled and this property is below zero, it will be removed from the world.}
